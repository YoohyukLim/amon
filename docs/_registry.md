...
<!-- cairn-managed: typed-dir 인덱스. atlas-init / atlas-sync 와 무관. -->

## Foundational

(영속 가치가 검증된 항목만. 수동 승급. ≤ 20 entries.)

## Active

- arch/260518-231927-single-command-flags.md — ADR: Single command + flag (subcommand 미채택)
- arch/260518-231928-mode-b-xpanes-spawn.md — ADR: Mode B = xpanes spawn (in-process multiplex 미채택)
